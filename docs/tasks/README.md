...
`server/middleware.ts`, so land one before starting the other. The dotted
arrows are "easier after", not "blocked by".
...
| · | 23 | [SKUs, compare-at prices and per-variant images](23-product-model-gaps.md) | Large | three columns on variants, one on product_images |
| · | 24 | [An administrator can reset a forgotten password](24-admin-password-reset.md) | Small | two columns on admin_users |
| · | 25 | [Object storage for uploaded images](25-object-storage-for-images.md) | Large | none |
