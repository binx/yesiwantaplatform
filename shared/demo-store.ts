  ...
  products: [
    {
      ...
      images: [
        {
          path: "demo/tote-front.svg",
          width: 900,
          height: 1200,
          alt: "Canvas tote, front view",
          widths: [],
          variantId: null,
        },
        {
          path: "demo/tote-side.svg",
          width: 900,
          height: 1200,
          alt: "Canvas tote, side view",
          widths: [],
          variantId: null,
        },
        {
      ...
      variants: [
        ...
        },
        {
          ...
          priceCents: 4200,
          sku: "CANVAS-TOTE-L",
          // On sale, so the storefront's Sale badge and struck price have
          // something real to show rather than being merely aspirational.
      ...
      images: [
        {
          ...
          width: 900,
          height: 1200,
          alt: "Two-colour risograph print",
          widths: [],
          variantId: null,
        },
      ],
    ...
    },
    {
      ...
      images: [
        {
          path: "demo/hoodie.svg",
          width: 1000,
          height: 1200,
          alt: "Zip hoodie, folded flat",
          widths: [],
          variantId: null,
        },
      ],
