...
from the blank-store review (29–34): 30 and 31 both edit the publish route in
`server/routes/admin.ts`, and 29 and 30 both touch `server/middleware.ts`; land
one of each pair before starting the other. 32, 33 and 34 are CSS and
client-side; 33 and 34 both touch the footer and page shell, so land one first. The dotted arrows are "easier after", not "blocked
by".
...
| · | 34 | [A primary colour that survives the dark scheme](34-dark-scheme-primary.md) | Medium | none |
<!-- end:tasks -->
